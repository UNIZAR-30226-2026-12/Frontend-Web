    ...
    <div className="rules">
      ...
      <main className="rules__content">
        ...
        <section className="rules__panel">
          ...
          <p>??? <strong>Modos:</strong> 1v1 (tablero 8x8, 2 jugadores) y 1v1v1v1 (tablero 16x16, 4 jugadores).</p>

          <p>?? <strong>Cómo se juega (paso a paso):</strong></p>
          <ul>
            ...
            <li>?? <strong>Movimiento normal:</strong> pones una ficha en una casilla vacía que encierra al menos una ficha rival entre tu ficha nueva y otra tuya, en línea recta (horizontal, vertical o diagonal).</li>
